...
function bytes_to_int64(bytes)
    ...
    -- 判断符号位并扩展符号
    if i64_and(bytes, {h = 0x80000000, l = 0x00000000}) ~= 0 then
        value = i64_or(bytes, {h = 0xFFFFFFFF, l = 0x00000000})
    end

-- l:2400000000
-- h:4294967295
-- int64 = value[1] + value[2]
-- int64 = value.h | value.l
string.
print(string.format("%x", 4294967295))
...
local byte1 = 0xF0
local byte2 = 0x34
local int64 = bytes_to_int64({l = byte1, h = byte2})
