-- local Panel2 = class("Panel2", function()
--     return fgui.UIPackage:createObject("Joystick", "Main")
-- end)

local Panel2 = class("Panel2", lt.UIPanelBase)

function Panel2:ctor(param)
    Panel2.super.ctor(self, param)
    -- self.obj = fgui.UIPackage:createObject("Joystick", "Main")
    fgui.UIPackage:addPackage("fairygui/Joystick")
    Panel2.super.onInit(self, "ui://Joystick/Main")
    self:onConstruct()
end

function Panel2:onConstruct()
...
function Panel2:onTouchBegin(context)
    print("=================================================")
...
function Panel2:onTouchMove( context)
    print("=================================================222")
    local evt = context:getInput();
...
function Panel2:onTouchEnd(context)
    print("=================================================33")
    local evt = context:getInput();
    if (self.touchId ~= -1 and evt:getTouchId() == self.touchId) then
