...
--------------------------------
-- 
-- @function [parent=#UIPackage] getVar 
-- @param self
-- @param #string key
-- @return string#string ret (return value: string)
...
--------------------------------
-- 
-- @function [parent=#UIPackage] getItemAssetByURL 
-- @param self
-- @param #string url
-- @param #int type
...
--------------------------------
-- 
-- @function [parent=#UIPackage] getBranch 
-- @param self
-- @return string#string ret (return value: string)
        
--------------------------------
-- 
-- @function [parent=#UIPackage] setBranch 
-- @param self
-- @param #string value
-- @return UIPackage#UIPackage self (return value: fgui.UIPackage)
...
--------------------------------
-- 
-- @function [parent=#UIPackage] setVar 
-- @param self
-- @param #string key
-- @param #string value
-- @return UIPackage#UIPackage self (return value: fgui.UIPackage)
