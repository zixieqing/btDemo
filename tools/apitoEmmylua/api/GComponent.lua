...
--------------------------------
-- 
-- @function [parent=#GComponent] getChildByPath 
-- @param self
-- @param #string path
-- @return GObject#GObject ret (return value: fgui.GObject)
...
--------------------------------
-- 
-- @function [parent=#GComponent] sendEventToLua 
-- @param self
-- @param #fgui.GComponent component
-- @param #int action
-- @return bool#bool ret (return value: bool)
...
--------------------------------
-- 
-- @function [parent=#GComponent] getBaseUserData 
-- @param self
